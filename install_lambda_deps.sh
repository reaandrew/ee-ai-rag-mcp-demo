...
pip install --target package/python langchain-text-splitters==0.3.8 pydantic==2.11.3 regex opensearch-py==2.0.0 requests-aws4auth==1.1.0 pyjwt==2.6.0 cryptography==36.0.0 aws-xray-sdk==2.12.0
